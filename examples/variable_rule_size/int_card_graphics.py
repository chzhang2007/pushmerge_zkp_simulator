...
from int_set import ID4, ID4Q, ID5, ID20, DUMMY_ONE, DUMMY_TWO, DUMMY_THREE, DUMMY_FOUR, DUMMY_FIVE, ENCODING, ENCODING_MOVE_1, ENCODING_MOVE_2, ENCODING_MOVE_3, ENCODING_MOVE_4, ENCODING_1_LENGTH_4, ENCODING_2_LENGTH_4, ENCODING_3_LENGTH_4, ENCODING_4_LENGTH_4
...
for card in ID4 + ID4Q + ID5 + ID20 + DUMMY_ONE + DUMMY_TWO + DUMMY_THREE + DUMMY_FOUR + DUMMY_FIVE + ENCODING + ENCODING_MOVE_1 + ENCODING_MOVE_2 + ENCODING_MOVE_3 + ENCODING_MOVE_4 + ENCODING_1_LENGTH_4 + ENCODING_2_LENGTH_4 + ENCODING_3_LENGTH_4 + ENCODING_4_LENGTH_4:
    match card.name:
        case "0":
            if card.face_up:
                file = (
