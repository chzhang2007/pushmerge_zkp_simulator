...
from int_set import ID2, ID2_R, ID4, ID5, ID20, ENCODING_MOVE_1, ENCODING_MOVE_2, ENCODING_MOVE_3, ENCODING_MOVE_4, ENCODING_1_LENGTH_4, ENCODING_2_LENGTH_4, ENCODING_3_LENGTH_4, ENCODING_4_LENGTH_4, ENCODING_1_LENGTH_2, ENCODING_2_LENGTH_2
...
for card in ID2 + ID2_R + ID4 + ID5 + ID20 + ENCODING_MOVE_1 + ENCODING_MOVE_2 + ENCODING_MOVE_3 + ENCODING_MOVE_4 + ENCODING_1_LENGTH_4 + ENCODING_2_LENGTH_4 + ENCODING_3_LENGTH_4 + ENCODING_4_LENGTH_4 + ENCODING_1_LENGTH_2 + ENCODING_2_LENGTH_2:
    match card.name:
        case "0":
            if card.face_up:
                file = (
