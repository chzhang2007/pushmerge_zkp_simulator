...
while 1: # game loop
    ...
    for event in pygame.event.get():
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 26:
            # turn the chosen card face-up
            for i in range(len(enc_cards_m_graphics.cardset)):
                if enc_cards_m_graphics.cardset[i].name == "1":
                    p_shuffled = i
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 27:
            # place the id row of matrix N
            id_cards_n = ID4.copy()
            id_cards_n_graphics = AlignedHand(
                id_cards_n,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 28:
            # place the id row of matrix Q
            id_cards_q = ID4Q.copy()
            id_cards_q_graphics = AlignedHand(
                id_cards_q,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 29:
            index_list = [(i + 1) for i in range(len(id_cards_n))]
            offset = random.randint(0, len(id_cards_n) - 1)
            for i in range(len(index_list)):
                index_list[i] = (index_list[i] + offset) % len(id_cards_n)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 30:
            # turn encoding row face-up
            for card in enc_cards_n_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 31:
            # take the chosen column and move it to matrix Q
            grid_state_m_graphics.cardset[p_shuffled].name = "blank"
            grid_state_m_graphics.cardset[p_shuffled].graphics = SuitCardGraphics(
                grid_state_m_graphics.cardset[p_shuffled],
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 32:
            index_list = [(i + 1) for i in range(len(id_cards_q))]
            random.shuffle(index_list)
            # shuffle the id row of matrix Q and turn it face-down
            for (i, card) in enumerate(id_cards_q):
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 33:
            # turn the rule cards face-up
            for (i, column) in enumerate(col_cards_q_graphics):
                for card in column.cardset:
                    card.face_up = True
        ...
        # simulate all legal moves
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 34:
            for i in range(4):
                if col_cards_q_graphics[i].cardset[1].name == "spade" and col_cards_q_graphics[i].cardset[2].name == "spade":
                    col_cards_q_graphics[i].cardset[1].name = "club"
                    col_cards_q_graphics[i].cardset[1].graphics = SuitCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 35:
            index_list = [(i + 1) for i in range(len(id_cards_q))]
            random.shuffle(index_list)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 36:
            # shuffle the id cards
            int_card_numbers = [card.number for card in id_cards_q]
            for (i, card) in enumerate(id_cards_q_graphics.cardset):
                card.name = str(int_card_numbers[index_list[i] - 1])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 37:
            # return rule cards to their original positions
            for (i, column) in enumerate(col_cards_q_graphics):
                for j in range(3):
                    col_cards_q_graphics[id_cards_q[i].number - 1].append_card(column.cardset[j])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 38:
            # return the cards in column 1 of matrix Q to their original positions in matrix N
            col_cards_n_graphics[removed_col_n].remove_all_cards()
            col_cards_n_graphics[removed_col_n].append_card(
                col_cards_q_graphics[0].cardset[1]
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 39:
            # discard the encoding row of matrix N
            for i in range(4):
                enc_cards_n_graphics.remove_card(enc_cards_n_graphics.cardset[0])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 40:
            # turn the id cards of N face-up
            for card in id_cards_n_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 41:
            # return rule cards to their original positions
            for (i, column) in enumerate(col_cards_n_graphics):
                for j in range(2):
                    col_cards_n_graphics[id_cards_n[i].number - 1].append_card(column.cardset[j])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 42:
            p0 = [(p_shuffled - 5) % 20, (p_shuffled - 1) % 20, (p_shuffled + 1) % 20, (p_shuffled + 5) % 20]
            p1 = [(p_shuffled - 10) % 20, (p_shuffled - 2) % 20, (p_shuffled + 2) % 20, (p_shuffled + 10) % 20]
            # return the cards in column 1 of matrix N to their original positions in matrix M
            for i in range(4):
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 43:
            # discard the encoding row of matrix M
            for i in range(20):
                enc_cards_m_graphics.remove_card(enc_cards_m_graphics.cardset[0])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 44:
            index_list = [(i + 1) for i in range(len(id_cards_m))]
            random.shuffle(index_list)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 45:
            # return the grid state of M to its original positions
            grid_state_m_temp = [0 for _ in range(20)]
            for (i, card) in enumerate(grid_state_m_graphics.cardset):
                grid_state_m_temp[id_cards_m[i].number - 1] = card
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 46:
            for card in id_cards_m_graphics.cardset:
                card.face_up = False
                card.graphics = IntCardGraphics(
                    card,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 48:
            # turn the encoding row face up
            for card in enc_cards_m_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 49:
            # turn the chosen card face-up
            for i in range(len(enc_cards_m_graphics.cardset)):
                if enc_cards_m_graphics.cardset[i].name == "1":
                    p_shuffled = i
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 50:
            # place the id row of matrix N
            id_cards_n = ID4.copy()
            id_cards_n_graphics = AlignedHand(
                id_cards_n,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 51:
            # place the id row of matrix Q
            id_cards_q = ID4Q.copy()
            id_cards_q_graphics = AlignedHand(
                id_cards_q,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 52:
            index_list = [(i + 1) for i in range(len(id_cards_n))]
            offset = random.randint(0, len(id_cards_n) - 1)
            for i in range(len(index_list)):
                index_list[i] = (index_list[i] + offset) % len(id_cards_n)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 53:
            # turn encoding row face-up
            for card in enc_cards_n_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 54:
            # take the chosen column and move it to matrix Q
            grid_state_m_graphics.cardset[p_shuffled].name = "blank"
            grid_state_m_graphics.cardset[p_shuffled].graphics = SuitCardGraphics(
                grid_state_m_graphics.cardset[p_shuffled],
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 55:
            index_list = [(i + 1) for i in range(len(id_cards_q))]
            random.shuffle(index_list)
            # shuffle the id row of matrix Q and turn it face-down
            for (i, card) in enumerate(id_cards_q):
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 56:
            # turn the rule cards face-up
            for (i, column) in enumerate(col_cards_q_graphics):
                for card in column.cardset:
                    card.face_up = True
        ...
        # simulate all legal moves
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 57:
            for i in range(4):
                if col_cards_q_graphics[i].cardset[1].name == "spade" and col_cards_q_graphics[i].cardset[2].name == "spade":
                    col_cards_q_graphics[i].cardset[1].name = "club"
                    col_cards_q_graphics[i].cardset[1].graphics = SuitCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 58:
            index_list = [(i + 1) for i in range(len(id_cards_q))]
            random.shuffle(index_list)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 59:
            # shuffle the id cards
            int_card_numbers = [card.number for card in id_cards_q]
            for (i, card) in enumerate(id_cards_q_graphics.cardset):
                card.name = str(int_card_numbers[index_list[i] - 1])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 60:
            # return rule cards to their original positions
            for (i, column) in enumerate(col_cards_q_graphics):
                for j in range(3):
                    col_cards_q_graphics[id_cards_q[i].number - 1].append_card(column.cardset[j])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 61:
            # return the cards in column 1 of matrix Q to their original positions in matrix N
            col_cards_n_graphics[removed_col_n].remove_all_cards()
            col_cards_n_graphics[removed_col_n].append_card(
                col_cards_q_graphics[0].cardset[1]
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 62:
            # discard the encoding row of matrix N
            for i in range(4):
                enc_cards_n_graphics.remove_card(enc_cards_n_graphics.cardset[0])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 63:
            # turn the id cards of N face-up
            for card in id_cards_n_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 64:
            # return rule cards to their original positions
            for (i, column) in enumerate(col_cards_n_graphics):
                for j in range(2):
                    col_cards_n_graphics[id_cards_n[i].number - 1].append_card(column.cardset[j])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 65:
            p0 = [(p_shuffled - 5) % 20, (p_shuffled - 1) % 20, (p_shuffled + 1) % 20, (p_shuffled + 5) % 20]
            p1 = [(p_shuffled - 10) % 20, (p_shuffled - 2) % 20, (p_shuffled + 2) % 20, (p_shuffled + 10) % 20]
            # return the cards in column 1 of matrix N to their original positions in matrix M
            for i in range(4):
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 66:
            # discard the encoding row of matrix M
            for i in range(20):
                enc_cards_m_graphics.remove_card(enc_cards_m_graphics.cardset[0])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 67:
            index_list = [(i + 1) for i in range(len(id_cards_m))]
            random.shuffle(index_list)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 68:
            # return the grid state of M to its original positions
            grid_state_m_temp = [0 for _ in range(20)]
            for (i, card) in enumerate(grid_state_m_graphics.cardset):
                grid_state_m_temp[id_cards_m[i].number - 1] = card
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 69:
            for card in id_cards_m_graphics.cardset:
                card.face_up = False
                card.graphics = IntCardGraphics(
                    card,
        ...
        # START OF MOVE CHECK 4
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 70:
            # add encoding row for chosen pile cut
            enc_cards_m = ENCODING_MOVE_4
            enc_cards_m_graphics = AlignedHand(
                enc_cards_m,
                card_set_size_wide,
                card_size=card_size,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 71:
            # turn the encoding row face up
            for card in enc_cards_m_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 72:
            # turn the chosen card face-up
            for i in range(len(enc_cards_m_graphics.cardset)):
                if enc_cards_m_graphics.cardset[i].name == "1":
                    p_shuffled = i
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 73:
            # place the id row of matrix N
            id_cards_n = ID4.copy()
            id_cards_n_graphics = AlignedHand(
                id_cards_n,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 74:
            # place the id row of matrix Q
            id_cards_q = ID4Q.copy()
            id_cards_q_graphics = AlignedHand(
                id_cards_q,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 75:
            index_list = [(i + 1) for i in range(len(id_cards_n))]
            offset = random.randint(0, len(id_cards_n) - 1)
            for i in range(len(index_list)):
                index_list[i] = (index_list[i] + offset) % len(id_cards_n)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 76:
            # turn encoding row face-up
            for card in enc_cards_n_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 77:
            # take the chosen column and move it to matrix Q
            grid_state_m_graphics.cardset[p_shuffled].name = "blank"
            grid_state_m_graphics.cardset[p_shuffled].graphics = SuitCardGraphics(
                grid_state_m_graphics.cardset[p_shuffled],
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 78:
            index_list = [(i + 1) for i in range(len(id_cards_q))]
            random.shuffle(index_list)
            # shuffle the id row of matrix Q and turn it face-down
            for (i, card) in enumerate(id_cards_q):
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 79:
            # turn the rule cards face-up
            for (i, column) in enumerate(col_cards_q_graphics):
                for card in column.cardset:
                    card.face_up = True
        ...
        # simulate all legal moves
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 80:
            for i in range(4):
                if col_cards_q_graphics[i].cardset[1].name == "spade" and col_cards_q_graphics[i].cardset[2].name == "spade":
                    col_cards_q_graphics[i].cardset[1].name = "club"
                    col_cards_q_graphics[i].cardset[1].graphics = SuitCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 81:
            index_list = [(i + 1) for i in range(len(id_cards_q))]
            random.shuffle(index_list)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 82:
            # shuffle the id cards
            int_card_numbers = [card.number for card in id_cards_q]
            for (i, card) in enumerate(id_cards_q_graphics.cardset):
                card.name = str(int_card_numbers[index_list[i] - 1])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 83:
            # return rule cards to their original positions
            for (i, column) in enumerate(col_cards_q_graphics):
                for j in range(3):
                    col_cards_q_graphics[id_cards_q[i].number - 1].append_card(column.cardset[j])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 84:
            # return the cards in column 1 of matrix Q to their original positions in matrix N
            col_cards_n_graphics[removed_col_n].remove_all_cards()
            col_cards_n_graphics[removed_col_n].append_card(
                col_cards_q_graphics[0].cardset[1]
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 85:
            # discard the encoding row of matrix N
            for i in range(4):
                enc_cards_n_graphics.remove_card(enc_cards_n_graphics.cardset[0])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 86:
            # turn the id cards of N face-up
            for card in id_cards_n_graphics.cardset:
                card.face_up = True
                card.graphics = IntCardGraphics(
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 87:
            # return rule cards to their original positions
            for (i, column) in enumerate(col_cards_n_graphics):
                for j in range(2):
                    col_cards_n_graphics[id_cards_n[i].number - 1].append_card(column.cardset[j])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 88:
            p0 = [(p_shuffled - 5) % 20, (p_shuffled - 1) % 20, (p_shuffled + 1) % 20, (p_shuffled + 5) % 20]
            p1 = [(p_shuffled - 10) % 20, (p_shuffled - 2) % 20, (p_shuffled + 2) % 20, (p_shuffled + 10) % 20]
            # return the cards in column 1 of matrix N to their original positions in matrix M
            for i in range(4):
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 89:
            # discard the encoding row of matrix M
            for i in range(20):
                enc_cards_m_graphics.remove_card(enc_cards_m_graphics.cardset[0])
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 90:
            index_list = [(i + 1) for i in range(len(id_cards_m))]
            random.shuffle(index_list)
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 91:
            # return the grid state of M to its original positions
            grid_state_m_temp = [0 for _ in range(20)]
            for (i, card) in enumerate(grid_state_m_graphics.cardset):
                grid_state_m_temp[id_cards_m[i].number - 1] = card
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 92:
            for card in id_cards_m_graphics.cardset:
                card.face_up = False
                card.graphics = IntCardGraphics(
                    card,
        ...
        elif event.type == pygame.MOUSEBUTTONDOWN and stage == 93:
            # turn the card at the target position face-up to ensure it is the agent
            grid_state_m_graphics.cardset[8].face_up = True
            grid_state_m_graphics.cardset[8].graphics = SuitCardGraphics(
                grid_state_m_graphics.cardset[8],
                filepath=Path("examples/pushmerge_zkp/images", f"{grid_state_m_graphics.cardset[8].name}.png"),
            )
            stage = 94
            grid_state_m_graphics.clear_cache()
